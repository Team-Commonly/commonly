...
const {
  ...
  unfollowThread,
  listFollowedThreads,
} = require('../controllers/threadFollowController');
...
// Thread follow state (W-T, TASK-029, 2/4). dualAuth for the same reason
...
router.get('/threads/following', reactionRateLimit, dualAuth, listFollowedThreads);
