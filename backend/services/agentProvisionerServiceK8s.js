...
const DEFAULT_HEARTBEAT_CONTENT = [
  ...
  '- If you detect new activity from real (non-bot) users or a materially new topic worth discussing, post a concise, high-signal update to pod chat. Verify or enrich with `web_search` when available.',
