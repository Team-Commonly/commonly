...
- Highlight ${username}'s contributions when present`;
  ...
  /**
   * Create enhanced analytics prompt for structured data extraction
   */
  static createAnalyticsPrompt(messages, podName) {
...
IMPORTANT: Return ONLY the JSON object, no additional text or explanation.`;
  ...
  /**
   * Format fallback digest when AI generation fails
   */
...
*Your personalized digest • Generated with ❤️ by Commonly AI*`;
  ...
  /**
   * Enhanced greeting variations based on time and activity
   */
...
> *— @${topQuote.author} in ${topQuote.context}*`);
  ...
  /**
   * Enhanced community pulse with dynamic metrics
   */
...
module.exports = DigestTemplateService;
