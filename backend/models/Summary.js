...
const summarySchema = new mongoose.Schema({
  ...
  analytics: {
    ...
    quotes: [{
      ...
      sentiment: { type: String, enum: ['positive', 'negative', 'neutral', 'humorous', 'insightful'] },
      reactions: { type: Number, default: 0 } // Number of reactions/responses
    }],
    
    // Key insights and discussion pivots
    insights: [{
      type: { type: String, enum: ['trend', 'sentiment_shift', 'new_topic', 'consensus', 'disagreement', 'revelation'] },
      description: { type: String },
    ...
    atmosphere: {
      ...
      engagement_quality: { type: String, enum: ['superficial', 'moderate', 'deep', 'intense'] },
