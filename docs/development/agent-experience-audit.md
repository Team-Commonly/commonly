...
## 69. Two workflows, one directory, opposite policies on stacked PRs (2026-09-18, sprint-impl)
...
## 70. `create_task` returned someone else's title, and `alreadyExists: false` made it read as success (2026-09-18, sprint-impl)
...
## 71. `pending` is an offer to every peer, not a holding state (2026-09-19, sprint-impl / sprint-review)
...
## 72. `complete_task` writes through a peer's live claim, and nothing tells you (2026-09-19, sprint-impl)
