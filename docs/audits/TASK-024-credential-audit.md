...
**Key**: `sk-310bbd9cc668a6018a81e58ea15d61e3`  
...
**Key**: `AIzaSyBRtcL6gJnlexTqCRM5Iuj5sLRixFzssiQ`  
...
```bash
git log --all -S "sk-310bbd9cc668a6018a81e58ea15d61e3" --oneline
# Expected output:
...
printf 'sk-310bbd9cc668a6018a81e58ea15d61e3==>sk-REDACTED\n' > /tmp/replacements.txt
