...
Keeps split three ways: **17** current-state docs whose CLI commands and routes were checked against the consumer, **29** current-state docs with no CLI or route claim to check (prose, not fact-checked here), **71** records (ADRs, audits, dated plans, the AX log) kept as history, not as current-state claims.

Lines: keep 27,404 · rewrite 12,584 · delete 11,684.
...
- **quill** (Luna writer 1): `README.md`, docs-site introduction, quickstart, and concepts.
- **luna-2 / luna-3**: writers not minted yet. luna-2 takes the rest of docs-site; luna-3 takes `docs/` rewrites. Until they're minted, quill picks up in that order.
- **otto**: supervisor and verifier. Owns the delete PRs, and re-verifies every keep at each CLI publish.
- **Sam**: ADR status lines. ADRs are records and don't get rewritten; the heavy-openclaw ADRs get a "superseded by ADR-021" line, and that is a ratifier's call.

Work items by owner (rewrite + delete + ADR status lines): luna-3 44, otto 43, luna-2 16, Sam 7, quill 5.
...
- **rewrite:** the subject is current, but the file has rot hits, cites a command 0.1.58 lacks, or cites a route that isn't served live.
...
| `docs-site/agents/memory.mdx` (nav) | 105 | 2026-09-01 | luna-2 | **rewrite** | cites /api/v1/pods/:id/memory/:file, not served live — openclaw 1x; 1/1 cited routes not served live |
...
| `docs-site/deployment/environment-variables.mdx` (nav) | 62 | 2026-09-01 | luna-2 | **rewrite** | gemini 2x |
...
| `docs-site/introduction.mdx` (nav) | 72 | 2026-08-21 | quill | **rewrite** | 0 rot, but no pods/seats/connectors/daemon framing; front door |
...
| `docs/DEMO_QUICKSTART.md` | 339 | 2026-08-24 | otto | **keep** | 0 rot; verified 4 CLI cmd(s) in 0.1.58 + 2 route(s) served live |
| `docs/LOCAL_CLAUDE_CODE_DEMO.md` | 166 | 2026-08-24 | otto | **keep** | 0 rot; verified 0 CLI cmd(s) in 0.1.58 + 1 route(s) served live |
| `docs/MCP_INTEGRATION.md` | 314 | 2026-09-01 | luna-3 | **rewrite** | openclaw 3x; attach 1x — broken link(s): `./adr/ADR-012-memory-propagation.md` |
...
| `docs/SUMMARIZER_AND_AGENTS.md` | 357 | 2026-08-01 | luna-3 | **rewrite** | openclaw 12x; clawdbot 1x; gemini 2x |
...
| `docs/agents/AGENT_AUTONOMY.md` | 222 | 2026-03-26 | luna-3 | **rewrite** | autonomy model still real; mechanics described are gateway-era — clawdbot 4x |
...
| `docs/agents/AGENT_RUNTIME.md` | 853 | 2026-07-22 | luna-3 | **rewrite** | openclaw 46x; clawdbot 26x; gemini 2x |
| `docs/agents/BUILDING_AN_AGENT.md` | 67 | 2026-04-12 | luna-3 | **rewrite** | openclaw 2x; clawdbot 2x |
...
| `docs/agents/COMMONLY_MCP.md` | 163 | 2026-08-26 | luna-3 | **rewrite** | openclaw 7x |
| `docs/agents/CONNECTING_LOCAL_AGENTS.md` | 95 | 2026-07-05 | otto | **keep** | 0 rot; verified 3 CLI cmd(s) in 0.1.58 + 0 route(s) served live |
| `docs/agents/LOCAL_CLI_WRAPPER.md` | 224 | 2026-08-29 | luna-3 | **rewrite** | deadhost 1x; gemini 2x; attach 2x |
| `docs/agents/NATIVE_RUNTIME.md` | 175 | 2026-04-12 | luna-3 | **rewrite** | openclaw 2x; clawdbot 2x |
| `docs/agents/README.md` | 75 | 2026-09-19 | luna-3 | **rewrite** | openclaw 7x; clawdbot 5x; attach 1x |
| `docs/agents/WEBHOOK_SDK.md` | 163 | 2026-08-30 | luna-3 | **rewrite** | deadhost 4x; attach 1x |
...
| `docs/agents/pi-adapter.md` | 129 | 2026-09-19 | otto | **keep** | 0 rot; verified 2 CLI cmd(s) in 0.1.58 + 0 route(s) served live |
...
| `docs/ai-features/AI_FEATURES.md` | 394 | 2026-04-06 | luna-3 | **rewrite** | gemini 6x |
| `docs/ai-features/DAILY_DIGESTS.md` | 533 | 2026-04-06 | otto | **keep** | 0 rot; verified 0 CLI cmd(s) in 0.1.58 + 4 route(s) served live |
| `docs/ai-features/README.md` | 26 | 2026-02-06 | luna-3 | **rewrite** | gemini 1x |
...
| `docs/architecture/ARCHITECTURE.md` | 151 | 2026-02-01 | luna-3 | **rewrite** | 1/3 cited routes not served live |
| `docs/architecture/CAP.md` | 190 | 2026-04-06 | luna-3 | **rewrite** | 6/6 cited routes not served live; docs/openapi/cap-kernel.yaml + ADR-004 are canon — openclaw 7x; gemini 1x; 6/6 cited routes not served live |
| `docs/architecture/CLAUDE_CODE_AGENT.md` | 193 | 2026-04-02 | luna-3 | **rewrite** | 6/7 cited routes not served live; claude adapter is current (attach claude) — deadhost 2x; 6/7 cited routes not served live |
| `docs/architecture/CLI.md` | 223 | 2026-04-02 | luna-3 | **rewrite** | openclaw 1x |
| `docs/architecture/README.md` | 19 | 2026-01-22 | luna-3 | **rewrite** | gemini 1x |
| `docs/architecture/WEBHOOK_RUNTIME.md` | 218 | 2026-04-02 | luna-3 | **rewrite** | openclaw 1x |
...
| `docs/cli/README.md` | 275 | 2026-04-16 | luna-3 | **rewrite** | deadhost 6x; attach 4x |
...
| `docs/deployment/DEPLOYMENT.md` | 646 | 2026-08-24 | luna-3 | **rewrite** | openclaw 4x; clawdbot 14x; deadhost 2x; gemini 5x |
...
| `docs/deployment/K8S_DEPLOYMENT_CHECKLIST.md` | 282 | 2026-07-03 | luna-3 | **rewrite** | clawdbot 2x; gemini 1x — broken link(s): `../ARCHITECTURE.md` |
| `docs/deployment/KUBERNETES.md` | 518 | 2026-07-03 | luna-3 | **rewrite** | openclaw 11x; clawdbot 9x; gemini 2x |
...
| `docs/development/BACKEND.md` | 652 | 2026-02-14 | luna-3 | **rewrite** | openclaw 18x; deadhost 1x; gemini 7x — broken link(s): `./DEPLOYMENT.md` |
| `docs/development/FRONTEND.md` | 273 | 2026-08-22 | luna-3 | **rewrite** | openclaw 4x — broken link(s): `./DEPLOYMENT.md` |
| `docs/development/LINTING.md` | 93 | 2026-01-22 | otto | **keep** | 0 rot; prose only, no CLI/route claim to verify |
| `docs/development/LITELLM.md` | 582 | 2026-06-25 | luna-3 | **rewrite** | openclaw 7x; clawdbot 2x; gemini 12x |
...
| `docs/development/local-credentials.md` | 161 | 2026-05-23 | luna-3 | **rewrite** | openclaw 1x; clawdbot 10x; gemini 3x |
| `docs/development/review-checklist.md` | 105 | 2026-09-19 | luna-3 | **rewrite** | clawdbot 1x |
| `docs/discord/DISCORD.md` | 737 | 2026-02-01 | otto | **keep** | 0 rot; verified 0 CLI cmd(s) in 0.1.58 + 4 route(s) served live |
| `docs/discord/DISCORD_APP_SETUP.md` | 77 | 2026-01-22 | otto | **keep** | 0 rot; prose only, no CLI/route claim to verify |
| `docs/discord/DISCORD_DEPLOYMENT.md` | 416 | 2026-01-26 | luna-3 | **rewrite** | merge the still-true parts into DISCORD.md |
...
| `docs/discord/DISCORD_INTEGRATION_ARCHITECTURE.md` | 266 | 2026-01-29 | luna-3 | **rewrite** | Gemini-era summarizer path; CLAUDE.md anchors it, so rewrite not delete — gemini 2x |
...
| `docs/discord/DISCORD_SETUP.md` | 218 | 2026-01-22 | luna-3 | **rewrite** | 6/11 cited routes not served live; merge into DISCORD.md — 6/11 cited routes not served live |
...
| `docs/groupme/README.md` | 41 | 2026-09-12 | luna-3 | **rewrite** | 1/1 cited routes not served live |
| `docs/instagram/README.md` | 29 | 2026-02-01 | otto | **keep** | 0 rot; prose only, no CLI/route claim to verify |
| `docs/integrations/COMMONLY_APP_PLATFORM.md` | 78 | 2026-01-29 | luna-3 | **rewrite** | 3/10 cited routes not served live |
...
| `docs/integrations/INTEGRATION_CONTRACT.md` | 95 | 2026-02-01 | luna-3 | **rewrite** | 1/3 cited routes not served live |
...
| `docs/integrations/README.md` | 52 | 2026-04-20 | luna-3 | **rewrite** | clawdbot 1x |
...
| `docs/runbooks/agent-avatar-resolution-and-recovery.md` | 103 | 2026-07-02 | luna-3 | **rewrite** | deadhost 3x; gemini 1x |
...
| `docs/runbooks/gcp-cost-optimization.md` | 217 | 2026-07-03 | luna-3 | **rewrite** | clawdbot 2x |
...
| `docs/runbooks/litellm-claude-code.md` | 185 | 2026-05-23 | luna-3 | **rewrite** | openclaw 11x |
| `docs/runbooks/litellm-guardrails.md` | 115 | 2026-07-01 | luna-3 | **rewrite** | openclaw 2x |
...
| `docs/runbooks/pg-pool-exhaustion.md` | 80 | 2026-05-31 | luna-3 | **rewrite** | 1/5 cited routes not served live |
| `docs/runbooks/reading-github-actions-state.md` | 343 | 2026-08-29 | luna-3 | **rewrite** | clawdbot 2x |
| `docs/security-patterns.md` | 147 | 2026-05-22 | otto | **keep** | 0 rot; prose only, no CLI/route claim to verify |
| `docs/self-hosting/helm-reference.md` | 234 | 2026-04-05 | luna-3 | **rewrite** | clawdbot 2x |
...
| `docs/skills/SKILLS_CATALOG.md` | 106 | 2026-02-06 | luna-3 | **rewrite** | skills are live (/api/skills mounted); catalog is gateway-era — openclaw 3x |
