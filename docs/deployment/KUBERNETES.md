...
- **GCP project**: `disco-catcher-490606-b0`
...
gcloud projects add-iam-policy-binding disco-catcher-490606-b0 \
  --member="serviceAccount:commonly-secrets-sa@disco-catcher-490606-b0.iam.gserviceaccount.com" \
  --role="roles/secretmanager.secretAccessor" --account=huboyang0410@gmail.com

# 3. Create SA key and store as k8s secret
gcloud iam service-accounts keys create /tmp/gcpsm-key.json \
  --iam-account=commonly-secrets-sa@disco-catcher-490606-b0.iam.gserviceaccount.com \
  --project=disco-catcher-490606-b0 --account=huboyang0410@gmail.com
